...
//  JourneyBook
//
//  Created by Dorukhan Uzun on 2020-09-09.
...
class ViewController: UIViewController, MKMapViewDelegate, CLLocationManagerDelegate {
                            ...
                            if let subtitle = result.value(forKey: "subtitle") as? String {
                                ...
                                if let latitude = result.value(forKey: "latitude") as? Double {
                                    ...
                                    if let longitude = result.value(forKey: "longitude") as? Double {
                                        ...
                                        placeName.text = annotationTitle
    ...
    @objc func chooseLocation(gestureRecognizer:UILongPressGestureRecognizer){
        if gestureRecognizer.state == .began {
            ...
            let touchPointCoordinates = self.mapView.convert(touchPoint, toCoordinateFrom: self.mapView)
            
            chosenLatitude = touchPointCoordinates.latitude
            chosenLongitude = touchPointCoordinates.longitude
    ...
    @IBAction func saveButton(_ sender: UIButton) {
        ...
        newPlace.setValue(placeName.text, forKey: "title")
